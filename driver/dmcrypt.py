...
class DMCrypt(object):
    ...
    def is_device_encrypted(dev_path, key):
        ...
        if exit_code == 0:
            ...
            logger.debug('got unexpected exit code from cryptsetup open. cmd=%s, exit_code=%s, stderr=%s, stdout=%s' % (cmd, exit_code, stderr, stdout))
    ...
    def luksFormat(dev_path, key, flags):
        ...
        # this command ignores any previous headers
